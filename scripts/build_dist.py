#!/usr/bin/env python3
"""Build and package ZeroEngine for Windows and Linux.
...
API_CS_DIR = REPO_ROOT / "ZeroEngine" / "api" / "cs"
PROFILE = "dist"
...
PACKAGES = ["ZeroEngine", "ZeroEditor"]
...
def main() -> int:
    ...
    zip_path = REPO_ROOT / "ZeroEngine.zip"
    print(f"\nPackaging {zip_path}...")
