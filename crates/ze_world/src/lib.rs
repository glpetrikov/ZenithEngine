...
use ze_components::{ExcludeFromBuild, IsActive, Name, Transform};
use ze_error::{IntoPubResult, WrapErr, ZPubResult};
	...
	pub fn register_defaults(registry: &mut ComponentRegistry) {
		registry.register::<Name>(
			...
			ze_types::Version {
				...
				minor: 0,
				patch: 0,
				pre: ze_types::Prerelease::EMPTY,
				build: ze_types::BuildMetadata::EMPTY,
			},
		);
